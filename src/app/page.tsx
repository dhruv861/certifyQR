    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        const clientData: CertificateData = {
          ...
          expirationDate: newCertificate.expirationDate ? new Date(newCertificate.expirationDate) : undefined,
        };
    ...
    <div className="container mx-auto px-4 py-8">
      <header className="mb-12 text-center">
        <div className="inline-flex items-center gap-4">
          ...
          <h1 className="font-headline text-4xl font-bold tracking-tight text-primary md:text-5xl">IADC WELLSHARP</h1>
        </div>
        <p className="mt-2 text-lg text-muted-foreground">IADC Well Control Accreditation Program - Admin Panel</p>
      </header>

      <div className="grid grid-cols-1 gap-12 lg:grid-cols-5">
        <div className="lg:col-span-2">
          <QrCertForm onGenerate={handleGenerateCertificate} isGenerating={isLoading} />
        </div>
